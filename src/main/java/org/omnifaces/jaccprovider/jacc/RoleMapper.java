...
public class RoleMapper {
    ...
    public static void onPolicyConfigurationCreated(final String contextID) {
        ...
        if (geronimoPolicyConfigurationFactoryInstance != null) {
            ...
            try {
                ...
                Object geronimoPolicyConfigurationProxy = Proxy.newProxyInstance(RoleMapper.class.getClassLoader(), new Class[] {geronimoPolicyConfigurationClass}, new InvocationHandler() {
    ...
    public RoleMapper(String contextID, Collection<String> allDeclaredRoles) {
